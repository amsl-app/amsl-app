...
mixin _$JournalFocus {
 ...
 String get id; String get name;@JsonKey(name: "icon") String get iconString; bool get hidden;@JsonKey(name: "user_id") String? get userID;
...
$JournalFocusCopyWith<JournalFocus> get copyWith => _$JournalFocusCopyWithImpl<JournalFocus>(this as JournalFocus, _$identity);
  ...
  /// Serializes this JournalFocus to a JSON map.
...
@useResult
$Res call({
 String id, String name,@JsonKey(name: "icon") String iconString, bool hidden,@JsonKey(name: "user_id") String? userID
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(name: "icon")  String iconString,  bool hidden, @JsonKey(name: "user_id")  String? userID)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JournalFocus() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(name: "icon")  String iconString,  bool hidden, @JsonKey(name: "user_id")  String? userID)  $default,) {final _that = this;
switch (_that) {
case _JournalFocus():
return $default(_that.id,_that.name,_that.iconString,_that.hidden,_that.userID);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name, @JsonKey(name: "icon")  String iconString,  bool hidden, @JsonKey(name: "user_id")  String? userID)?  $default,) {final _that = this;
switch (_that) {
case _JournalFocus() when $default != null:
return $default(_that.id,_that.name,_that.iconString,_that.hidden,_that.userID);case _:
  return null;
...
class _JournalFocus implements JournalFocus {
  const _JournalFocus({required this.id, required this.name, @JsonKey(name: "icon") required this.iconString, required this.hidden, @JsonKey(name: "user_id") this.userID});
  factory _JournalFocus.fromJson(Map<String, dynamic> json) => _$JournalFocusFromJson(json);

@override final  String id;
@override final  String name;
@override@JsonKey(name: "icon") final  String iconString;
...
@override
Map<String, dynamic> toJson() {
  return _$JournalFocusToJson(this, );
}
