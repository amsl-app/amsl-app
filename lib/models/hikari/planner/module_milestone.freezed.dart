...
mixin _$ModuleMilestone {
 ...
 String get id; String get title; DateTime get date;@JsonKey(name: 'already_imported') bool get alreadyImported; String? get description;
...
$ModuleMilestoneCopyWith<ModuleMilestone> get copyWith => _$ModuleMilestoneCopyWithImpl<ModuleMilestone>(this as ModuleMilestone, _$identity);
  ...
  /// Serializes this ModuleMilestone to a JSON map.
...
@useResult
$Res call({
 String id, String title, DateTime date,@JsonKey(name: 'already_imported') bool alreadyImported, String? description
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  DateTime date, @JsonKey(name: 'already_imported')  bool alreadyImported,  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ModuleMilestone() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  DateTime date, @JsonKey(name: 'already_imported')  bool alreadyImported,  String? description)  $default,) {final _that = this;
switch (_that) {
case _ModuleMilestone():
return $default(_that.id,_that.title,_that.date,_that.alreadyImported,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  DateTime date, @JsonKey(name: 'already_imported')  bool alreadyImported,  String? description)?  $default,) {final _that = this;
switch (_that) {
case _ModuleMilestone() when $default != null:
return $default(_that.id,_that.title,_that.date,_that.alreadyImported,_that.description);case _:
  return null;
...
class _ModuleMilestone implements ModuleMilestone {
   _ModuleMilestone({required this.id, required this.title, required this.date, @JsonKey(name: 'already_imported') required this.alreadyImported, this.description});
  factory _ModuleMilestone.fromJson(Map<String, dynamic> json) => _$ModuleMilestoneFromJson(json);

@override final  String id;
@override final  String title;
@override final  DateTime date;
@override@JsonKey(name: 'already_imported') final  bool alreadyImported;
...
@override
Map<String, dynamic> toJson() {
  return _$ModuleMilestoneToJson(this, );
}
